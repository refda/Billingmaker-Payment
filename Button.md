...
<form action="https://payment.billingmaker.com/sepa/" method="post">
	...
	<input type="hidden" name="methods" value="dd,pp,cc,uu,so,bz" />
...
| methods  | Zahlungsmethoden (kommasepariert; dd=Lastschrift, cc=Kreditkarte, pp=PayPal, uu=Überweisung, so=Klarna, bz=Barzahlen)  | Nein, dann dd |
